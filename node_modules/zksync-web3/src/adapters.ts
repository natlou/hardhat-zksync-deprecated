...
export function AdapterL1<TBase extends Constructor<TxSender>>(Base: TBase) {
    return class Adapter extends Base {
        ...
        async approveERC20(
            token: Address,
            amount: BigNumberish,
            overrides?: ethers.CallOverrides & { bridgeAddress?: Address }
        ...
        async finalizeWithdrawal(withdrawalHash: BytesLike, index: number = 0) {
            ...
            const proof = await this._providerL2().getMessageProof(receipt.blockNumber, sender, log.topics[2]);
    ...
    return class Adapter extends Base {
        ...
        async getWithdrawTx(transaction: {
            ...
            if (tx.bridgeAddress == null) {
                const bridges = await this._providerL2().getDefaultBridgeAddresses();
