import { ethers, BigNumber, utils, BytesLike } from 'ethers';
...
export declare class Provider extends ethers.providers.JsonRpcProvider {
    ...
    getMessageProof(blockNumber: ethers.BigNumberish, sender: Address, messageHash: BytesLike): Promise<MessageProof | null>;
